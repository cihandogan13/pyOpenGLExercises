...
class LoadMesh(Mesh):
    def __init__(self, filename, imagefile, programId, drawType=GL_TRIANGLES, 
        ...
        for index in range(len(vertices)):
            ...
            colors.append(1)
            colors.append(1)
        super().__init__(programId, vertices, imagefile, vertexNormals, vertexUVs, colors, drawType, location, rotation, scale, moveRotation, moveTranslate, moveScale)
